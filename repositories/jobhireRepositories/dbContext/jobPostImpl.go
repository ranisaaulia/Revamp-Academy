...
func (q *Queries) GetListJobPost(ctx context.Context) ([]models.JobhireJobPost, error) {
...
func (q *Queries) ListJobPost(ctx context.Context) ([]models.MergeJobAndMaster, error) {
	rows, err := q.db.QueryContext(ctx, listJobPost)
	if err != nil {
		return nil, err
	}
